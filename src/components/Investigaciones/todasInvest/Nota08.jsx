  ...
  return (
    <>
      <h4 className={styles.singularText}>
        ...
        barrio. Y allí, el primer obstáculo: la falta de formación policial para
      ...
      <h4 className={styles.singularText}>
        ...
        saben que hay asesoramiento, a la policía le falta formación con
        perspectiva de género porque no están capacitados para desactivar y
      ...
      <h4 className={styles.singularText}>
        ...
        Flores se organizó frente a la inacción de la policía y el estado que no
        daba respuesta para encontrar a las pibas que desaparecían. Galarza
        cuenta que “en relación a la policía tuvimos nuestro momento tensísimo
        que fue cuando no accedían a tomar las denuncias, sobretodo en lo
        relativo a las desapariciones de las pibas. Decían que tenía que pasar
        determinada cantidad de tiempo, que se habían ido con un novio, que ya
        iban a volver o cosas así. Mucha estigmatización y estamos hablando de
        niñeces de entre 13 y 17 años”. Sobretodo, dice Griselda, les pasó con
      ...
      <h4 className={styles.singularText}>
        ...
        tratar de calmarla y ver la decisión que toma ella y siempre respetando
        la decisión de la compañera”, cuenta Felicita Zorrilla Servian, que
        acompaña denuncias de violencias de género en la zona de Barracas, en el
        barrio 21-24. La referenta coincide en la falta de formación policial en
        la temática y agrega: “No me gustó el accionar policial con respecto a
        una compañera que estábamos acompañando víctima de un intento de abuso
        sexual. La acompañamos junto con la madre. Ella tenía 19 años, lo que no
        me gustó son las horas eternas de espera que no terminan nunca,
        interrogatorio que se prolonga, insisten y revictimizan, qué va a pasar
        con la pericia, llevarla de un lugar a otro y lo peor fue subirnos a una
        camioneta con vidrios polarizados y traerla de nuevo a ella para que
        indique el lugar donde el agresor intentó abusar de ella, eso a mí me
        pareció muy cruel. Ella estaba reviviendo toda la situación”, cuenta. En
      ...
      <h4 className={styles.singularText}>
        ...
        violentadas. Tenemos policía cerca de la zona, pero las mujeres fueron
        humilladas y violentadas, maltratadas (por ellos) y los casos de
      ...
      <h4 className={styles.singularText}>
        ...
        está decidida, la acompañan. “Muchas veces no se animan a denunciar
        porque no pueden salir de la casa o por los chicos y ahí las acompañamos
        nosotros. Hay mujeres que hacen la denuncia y tienen suerte, depende de
        quién les toque en la comisaría”, asegura. En Fátima, las denuncian
        deberían hacerse en la excomisaría 36 (actual comisaría vecinal 8 B),
        que en general no da respuesta. La policía suele referirlas a La Boca o,
        directamente a la Oficina de Violencia Doméstica (OVD) que está en
        microcentro (Lavalle 1250). “Ellos no toman denuncias por violencia de
      ...
      <h4 className={styles.singularText}>
        ...
        trámites que deben que hacer. “Pedir botón antipánico, por ejemplo, es
        un trámite larguísimo y depende en qué situación se encuentre la mujer.
        Si hay abuso (a un niñe) es más rápido porque entra minoridad, en una
        semana se resuelve. Si es violencia de género lleva un mes o dos meses
        para resolver o tenés que denunciar directo a la fiscalía, es más
        rápido. Si es por comisaría, tarda siempre”. Como puede verse, el rol de
        la comisaría queda en segundo plano, en la experiencia de barrio Fátima
        es conveniente ir directo a la fiscalía. Las dificultades se multiplican
      ...
      <h6 className={styles.span}>
        ...
        las violencias de género no solo se concretan en la distancia que tienen
        que recorrer sino también en la cantidad de trámites que tienen que
        hacer.
      </h6>
      ...
      <h4 className={styles.singularText}>
        ...
        y conflictivo. Parte de la historia del traspaso de la seguridad del
        territorio porteño desde las fuerzas federales a las de la policía de la
        Ciudad puede leerse en este informe del Mapa de la Policía. Pero ¿quién,
        efectivamente, se hace cargo de lo que pasa en los territorios? En el
        Bajo Flores, cuenta Griselda, la policía de la Ciudad actúa sobre la
      ...
      <h4 className={styles.singularText}>
        ...
        policía golpea a un detenido en la comisaría y llama a gendarmería para
        que lo traslade, a lo que esta fuerza se niega. Mientras las discusiones
        entre las fuerzas siguen, el detenido no recibe asistencia médica. Los
        tironeos entre la policía de la Ciudad y las fuerzas federales
        contempladas en el Decreto cuentan con un trasfondo legal que frena la
      ...
      <h6 className={styles.span}>
        ...
        actúa sobre la periferia y gendarmería, adentro. “Ahí ya hay un
        quilombo. Si hacés la denuncia en la policía de la Ciudad, a la villa no
        entra. Fin del cuento”, dice.{" "}
      </h6>
      ...
      <h4 className={styles.singularText}>
        ...
        Familiar y de Género de la Policía de la Ciudad de Buenos Aires. Según
        dijo a este medio, hay cuatro comisarías de Protección Familiar y de
        Género (norte/sur/este/oeste) que abarcan toda la Ciudad de Buenos
        Aires. “En todas las comisarías se reciben denuncias de violencia. Si es
        un hecho de abuso sexual, seguramente esa comisaría va a trasladar a la
        víctima al hospital o a estas comisarías con alguien del mismo género”,
        afirmó. Las cuatro comisarías tienen anexos, la de Lugano tiene el anexo
      ...
      <h4 className={styles.singularText}>
        ...
        la Brigada de Victimas contra la Violencia. Ahí la asiste un equipo
        interdisciplinario, hacen un informe para mandar al juzgado, la atiende
        un médico legista, se le da un botón antipánico”, explica Mercado. “El
        accionar después de la denuncia lo dirige la Justicia con el operador de
        género. Si hay peligro de vida se le pone una consiga en la puerta.
        Siempre se hace seguimiento durante 5 días, depende el tipo de denuncia,
      ...
      <h4 className={styles.singularText}>
        ...
        años pasamos de una oficina chiquita con 8 personas a una
        Superintendencia. Somos pioneros en toda América con esta estructura de
        género que tiene esta policía. No hay otra con esta estructura de
        género”, aseguró. La Superintendencia consta de dos grandes áreas de
        trabajo, una de asistencia y prevención y otra netamente policial que
        encabeza Mercado. “La primera sólo capacita dentro de la policía y
        también afuera, en escuelas primarias sobre bullying y en secundaria,
        sobre noviazgos violentos”, contó. Las capacitaciones policiales son
        permanentes a lo largo del año y prestadas por “psicólogas y abogadas,
      ...
      <h4 className={styles.singularText}>
        ...
        a una señora que le robaron la cartera. La toma de la declaración es de
        dos horas. El policía tiene que estar formado, obligatoriamente”. No
        obstante, reconoció que “esto no quiere decir que no haya gente que no
      ...
      <h4 className={styles.singularText}>
        ...
        Las referentas consultadas coinciden en que conseguir cualquier tipo de
        subsidio para las denunciantes se convierte en un tramiterío
        inexplicable, una especie de vulneración de derechos dentro de otra.
        “Las políticas públicas, cuando no se capilarizan, o sea cuando vos te
        sentás en un escritorio y pensás una política pero no se materializa en
        la presencia del estado concreto con compañeras trabajando en el
      ...
      <h4 className={styles.singularText}>
        ...
        poseen dispositivos estatales cercanos y suficientes en donde realizar
        las denuncias ni se forma a las personas que deben dar respuesta a estos
        requerimientos. En la mayoría de los casos, esos mismos funcionarios y
        funcionarias se encuentran realizando tareas en condiciones de
        insalubridad y mal pagas. No tienen las herramientas y mecanismos que
        para dar respuesta inmediata a la problemática como, por ejemplo,
      ...
      <h4 className={styles.singularText}>
        ...
        “Terminan en situaciones graves por sostener vínculos violentos por el
        sometimiento económico con el agresor. Mientras no haya generación real
        y promoción de trabajo y un apoyo económico, va a seguir sucediendo. Las
      ...
      <h4 className={styles.singularText}>
        ...
        habitan los barrios de emergencia. Que los vecinos no cuenten con
        infraestructura adecuada y que deban trasladarse hasta el centro de la
        ciudad para radicar una denuncia también es violencia. Rosa Ortega, del
        barrio Fátima, trata de encontrarle la vuelta: “no sé si debería haber
        una comisaría, tendría que haber una cartera donde tomar la denuncia y
        llevarla donde corresponde o que en la comisaría haya un equipo de
        asistente social o psicóloga, que no te den vueltas de un lugar a otro.
        Y muchas veces quienes denuncian no pueden sostenerla (anímicamente) o
      ...
      <h4 className={styles.singularText}>
        ...
        víctimas”. Pero no solo ello, sino que las comisarías e inclusive las
        unidades de género no están preparadas para recibir estas situaciones.
        “No trabajan bien, son expulsivos y realmente asesoran mal y asesoran
        cuando no deberían. No conocen los territorios y las problemáticas y eso
      ...
      <h6 className={styles.span}>
        ...
        hay que combatir la precariedad que rodea a las políticas destinadas a
        atender las violencias de género en los barrios: no se poseen
        dispositivos estatales cercanos y suficientes en donde realizar las
        denuncias ni se forma a las personas que deben dar respuesta a estos
        requerimientos.{" "}
      </h6>
      ...
      <h4 className={styles.singularText}>
        ...
        respuesta inmediata a una emergencia o porque se encuentran totalmente
        colapsados. “Hemos tenido pésimas experiencias con la OVD, siempre y
        cada vez, no hay equipo que tenga empatía. No saben cómo abordar la
        situación. Entiendo que están colapsados pero no justifica el trato
      ...
      <h4 className={styles.singularText}>
        ...
        estos barrios como así también que en dichas zonas no existen las
        comisarías especializadas donde realizar las denuncias las 24 horas”.
        Según cuenta Bañares, “la Línea 137 recibe llamados de todo el país,
        alrededor de 30 llamadas por día, entre las que hay pedidos de
        orientación y asesoramiento como así también acompañamientos”. En el
        radio de la CABA, los equipos técnicos conformados por psicólogos y
        trabajadores sociales que atienden la línea son los que intervienen en
        los territorios mientras que en las provincias, se articula con otras
        instituciones. La cantidad de llamados aumentó de forma significativa
        con la pandemia, por lo que además del 137, la línea habilitó un número
        de Whatsapp: 113133-1000. “La intervención territorial no sólo tiene
        como eje la efectivización de la denuncia de las víctimas de violencias
      ...
      <h4 className={styles.singularText}>
        ...
        fotografía actual de los obstáculos más prominentes al momento de
