    ...
    <>
      <div className={styles.NotaContainer}>
        <h4 className={styles.singularText}>
          En enero de 2025, la Policía de la Ciudad se instaló oficialmente en
          el Bajo Flores. Durante más de 15 años, la fuerza que ocupó ese lugar
          fue Gendarmería Nacional (GNA). El sur de la ciudad de Buenos Aires,
          además de ser intencionalmente marginado por los sucesivos gobiernos,
          respira una dinámica propia en materia de seguridad. Este territorio
          sin independencia tiene un perímetro difuso que se dibuja
          constantemente por la vida de sus habitantes: el vínculo de los
          vecinos con los agentes, el rol del narcotráfico y el abordaje de un
        ...
        <h4 className={styles.singularText}>
          ...
          semáforos que permiten giros en ambas direcciones resultan ajenos a
        ...
        <h4 className={styles.singularText}>
          ...
          es entender que a partir de acá, las lógicas de la seguridad y las
          leyes no son las mismas que para el resto de la ciudad. Y no es una
          sensación infundada, tiene ya varios años de historia.
        </h4>
        <h6 className={styles.span}>
          El Operativo Cinturón Sur estaba dirigido a los barrios de Bajo
        ...
        <h4 className={styles.singularText}>
          ...
          ) dirigido a los barrios de Bajo Flores, Nueva Pompeya, Lugano,
          Soldati, Barracas y La Boca. Según reza el texto publicado entonces,
          su objetivo era “optimizar el servicio de seguridad ciudadana en la
          Capital Federal mediante la complementación operativa sinérgica de los
          cuerpos policiales y de las fuerzas de seguridad federales por zonas”.
        </h4>
        <h4 className={styles.singularText}>
          Luego, en 2017 con la renombrada Policía de la Ciudad, el operativo
          fue dado de baja con el decreto{" "}
          <a
            className={styles.link}
        ...
        <h4 className={styles.singularText}>
          ...
          de miedo y desconfianza. La GNA, en cambio, parecía tener una
        ...
        <h4 className={styles.singularText}>
          ...
          este caso, comparte su lectura de la dinámica en materia de seguridad
        ...
        <h4 className={styles.singularText}>
          ...
          frenar a las camionetas de los talleres textiles, sacarles la
          mercadería y reventarlos, saber a quién y cómo parar. Cuidar hacia la
          ciudad lo que sale, guetificarlo”.
        </h4>
        <h4 className={styles.singularText}>
          Esta acción en los márgenes parece limitarse a una labor orientada a
          desgranar el flujo económico del Bajo: quién produce qué, quién tiene
        ...
        <h4 className={styles.singularText}>
          ...
          invitaban a pelear “de puño” a pibes, a veces, menores de edad; casos
          de gatillo fácil como el de{" "}
          <a
            className={styles.link}
        ...
        <h4 className={styles.singularText}>
          ...
          ser una carta de seguridad. El intercambio es sencillo: mientras
        ...
        <h4 className={styles.singularText}>
          ...
          depende del respeto entre sí y sus mercados. E incluso esta
          tranquilidad vuelve a tambalear cuando el Gobierno decide desbaratar a
          las bandas.
        </h4>
        <h4 className={styles.singularText}>
        ...
        <h4 className={styles.singularText}>
          ...
          Gendarmería, pero los vecinos y vecinas{" "}
          <a
            className={styles.link}
