  ...
  return (
    <>
      ...
      <h4 className={styles.singularText}>
        ...
        revelado a partir de un pedido de acceso a la información realizado por
      ...
      <h4 className={styles.singularText}>
        ...
        a Dilan Carpio, joven de 16 años que había sido herido después de entrar
        a robar a un Carrefour Express del microcentro. A pesar de que las
        cámaras de seguridad del local registraron la secuencia completa, en
        2019 la jueza a cargo del Juzgado Criminal N°6 de la Capital Federal,
        María Alejandra Provítola, sobreseyó a Escobar por considerar que había
      ...
      <h4 className={styles.singularText}>
        ...
        2021, Lucas salía de un entrenamiento de fútbol en el club Barracas
        Central con sus amigos cuando una brigada de civil los interceptó. Los
        jóvenes pensaron que iban a ser víctimas de un robo e intentaron escapar
      ...
      <h4 className={styles.singularText}>
        ...
        fútbol (Barracas Central, conducido por el hijo del presidente de la
        AFA, Claudio “el Chiqui” Tapia) el que llamó a los medios para desmentir
        la versión que quería hacer circular la Policía –dijo María del Carmen
      ...
      <h4 className={styles.singularText}>
        ...
        un vicio el que tienen los policías de cebarse contra los más
        desprotegidos, contra los que van a reclamar, los que no tienen para
        pagar un abogado”, dijo Luciano Peretto, abogado que lleva adelante las
        querellas de varias causas por gatillo fácil, entre ellas la de Facundo
      ...
      <h6 className={styles.span}>
        ...
        discriminación social. Yo diría que es un vicio el que tienen las
        policías de cebarse contra los más desprotegidos, contra los que van a
      ...
      <h4 className={styles.singularText}>
        ...
        que encabezaba el corte para evitar el paso de algunos autos. En uno de
        ellos viajaba un policía porteño, para quien una discusión subida de
      ...
      <h4 className={styles.singularText}>
        ...
        también Claudio Romano, el 1 de octubre de 2019. El hombre se acercó
        hasta la ventanilla de un patrullero en el que iban los policías Ramón
        Pérez, Daniela López y Beatriz Manzanelli. Los agentes dijeron que
        Claudio estaba “enajenado” y que le causó heridas leves con una navaja a
      ...
      <h4 className={styles.singularText}>
        ...
        matrimonio sufrió una entradera en su casa de Parque Avellaneda en junio
        de 2019 cuando una policía, Sonia Soloaga, ingresó para robar y los
        mató. En un inicio, la agente reportó el caso como si hubiera sido un
      ...
      <h6 className={styles.span}>
        ...
        las víctimas habían recibido disparos en la cabeza o desde atrás. De
        acuerdo al relevamiento hecho por El Grito del Sur, de las 38 víctimas
        de gatillo fácil de los últimos seis años, hubo 7 que recibieron un tiro
      ...
      <h4 className={styles.singularText}>
        ...
        Grito del Sur, de las 38 víctimas de gatillo fácil de los últimos seis
        años hubo 7 que recibieron un tiro por la espalda y otros 5 que
        recibieron disparos en la cabeza. Sin embargo, ninguno tuvo hasta ahora
